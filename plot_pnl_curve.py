...
if is_gege_server:
    ...
    pnl_folder = os.path.join(data_folder, 'pnl', 'pnl1011', 'final', 'pnl_summary_spread15_innovativeFire2new_maxPnl_25000_quickLossDelayed_noTrendFollow_SpecialExclude_selected_portfolio3_Phase1ComplexClose')
