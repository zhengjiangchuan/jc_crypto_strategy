...
#Hutong
#currency_df = currency_df[currency_df['currency'].isin(['EURJPY', 'GBPUSD', 'EURUSD'])]
...
#currency_df = currency_df[currency_df['currency'].isin(['AUDCAD', 'EURNZD', 'GBPNZD', 'NZDCAD', 'NZDJPY', 'AUDJPY', 'CHFJPY'])]
