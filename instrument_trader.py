...
class CurrencyTrader(threading.Thread):
    ...
    def calculate_signals(self):
        ...
        self.data_df['long_filter_exempt'] = self.data_df['fast_vegas_up'] & self.data_df['previous_fast_vegas_up'] &\
                                             (self.data_df['vegas_distance_gradient'] < 0) & (self.data_df['prev_vegas_distance_gradient'] < 0) & self.data_df['guppy_all_above_vegas']
        ...
        self.data_df['can_long'] = self.data_df['can_long'] & (~self.data_df['must_reject_long'])
        ###############
        ...
        self.data_df['short_filter_exempt'] = self.data_df['fast_vegas_down'] & self.data_df['previous_fast_vegas_down'] &\
                                             (self.data_df['vegas_distance_gradient'] < 0) & (self.data_df['prev_vegas_distance_gradient'] < 0) & self.data_df['guppy_all_below_vegas']
        ...
        self.data_df['can_short'] = self.data_df['can_short'] & (~self.data_df['must_reject_short'])
        ############
        ...
        self.data_df['vegas_long_cond4'] = self.data_df['recent_min_low_price_to_upper_vegas'] * self.lot_size * self.exchange_rate <= 1 #0
        ...
        self.data_df['vegas_short_cond4'] = self.data_df['recent_min_high_price_to_lower_vegas'] * self.lot_size * self.exchange_rate <= 1
                ...
                while long_start_id + j < self.data_df.shape[0]:
                    ...
                    if cur_data['low'] <= actual_used_stop_loss: #New
                        ...
                        if use_smart_close_position_logic and cur_data['guppy_all_strong_aligned_long']:
                            ...
                            print("high price reach long_target_profit_price " + str(long_target_profit_price))
                            print("Due to guppy_all_strong_aligned_long, current_stop_loss=" + str(current_stop_loss) + ", current_used_stop_loss=" + str(current_used_stop_loss))
                        ...
                        if cur_data['guppy_all_strong_aligned_long']:
                            ...
                            if not last_data['guppy_all_strong_aligned_long']:  #Comment
                                print("Special: time = " + str(cur_data['time']))
                            ...
                            if current_used_stop_loss - long_stop_loss_price < -(1e-5): #Guoji
                                ...
                                if not last_data['guppy_all_strong_aligned_long']:  #Comment
                                    print("However, because current_used_stop_loss set lower than stop loss, revert it back to " + str(current_used_stop_loss))
                ...
                while short_start_id + j < self.data_df.shape[0]:
                    ...
                    if cur_data['high'] >= actual_used_stop_loss:  #New
                        ...
                        if cur_data['guppy_all_strong_aligned_short']:
                            ...
                            if not last_data['guppy_all_strong_aligned_short']:  #Comment
                                print("Special: time = " + str(cur_data['time']))
