...
#from vegas_strategy_once import self.profit_loss_ratio
import math
...
class CurrencyTrader(threading.Thread):
    ...
    def calculate_signals(self):
        ...
        self.data_df['must_reject_long2'] = self.data_df['must_reject_long2'] &\
                                             (((self.data_df['fast_vegas'] > self.data_df['slow_vegas']) & (self.data_df['vegas_phase_duration'] >= 24*5)) | (self.data_df['fast_vegas'] < self.data_df['slow_vegas']))
        ...
        #Old  #0823 48 changed to -1   last condition removed
        self.data_df['final_short_condition2'] = (self.data_df['bar_down_phase_duration'] > 48) &\
                                                 (self.data_df['middle'] < self.data_df['lower_vegas']) &\
                                                 (self.data_df['fast_vegas'] < self.data_df['slow_vegas']) &\
        ...
        self.data_df['vegas_long_cond11'] = (self.data_df['close'] < self.data_df['guppy_max']) | \
                                            (self.data_df['fast_vegas'] > self.data_df['slow_vegas']) | self.data_df['guppy_all_strong_aligned_long']  #0825

        #self.data_df['vegas_long_cond11'] = True  #0823
        ...
        self.data_df['vegas_short_cond11'] = (self.data_df['close'] > self.data_df['guppy_min']) | \
                                             (self.data_df['fast_vegas'] < self.data_df['slow_vegas']) | self.data_df['guppy_all_strong_aligned_short']  #0825

        #self.data_df['vegas_short_cond11'] = True
        ...
        #     self.data_df['vegas_long_fire'],
        #     self.data_df['close'] + self.profit_loss_ratio * self.data_df['long_stop_range_rt'],
        #     np.nan
        # )
        #################################################
        ...
        #     self.data_df['vegas_short_fire'],
        #     self.data_df['close'] - self.profit_loss_ratio * self.data_df['short_stop_range_rt'],
        #     np.nan
        # )
        #################################################
