...
#currency_df = currency_df[currency_df['currency'].isin(['AUDCAD', 'AUDCHF'])]
...
if True:
    ...
    dest_folder = "C:\\Forex\\new_experiments\\0704\\forex_real_time_new2_improve_filter_vegas_guppy_other_side_fixBug_15_urgentStopLoss200_quick2_improve"
