...
def start_do_trading():
    ...
    currencies_to_run = ['GBPCHF'] #'AUDCHF', 'EURAUD', 'GBPAUD', 'NZDCAD', 'NZDUSD'
    ...
    chart_folder_name = "chart_ratio1Adjust_0512_correct2_filter2_realTime_w2_erase2_new_back3_noLasting_single"
