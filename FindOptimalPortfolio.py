...
root_dir = "C:\\Users\\admin\\" + ("JCForex_prod2" if is_crypto else "JCForex_prod") + "\\portfolio_construction_vegasStrategy_prod_bothWrong_relaxIfGuppyStrong_rmGuppyMiMaxCond_rmCond9_run"
...
def calculate_currency_performance(end_date, currency_list, sorted, accumulated_mode, start_date = datetime(2023, 4, 1)):
    ...
    trade_files = [os.path.join(forex_dir,
                                "all_pnl_chart_ratio1vegasStrategy_prod_bothWrong_relaxIfGuppyStrong_rmGuppyMiMaxCond_rmCond9_run\\all_trades.csv"),
                   os.path.join(forex_dir,
                                "all_pnl_chart_ratio10vegasStrategy_prod_bothWrong_relaxIfGuppyStrong_rmGuppyMiMaxCond_rmCond9_run\\all_trades.csv")]
...
end_dates = [datetime(2024,8,31)]  #datetime(2024,4,16)
